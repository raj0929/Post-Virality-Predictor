...
if menu_tabs:
    ...
    if menu_tabs == "Analytics":
        ...
        top_posts = df.nlargest(10, 'virality_score')[
                ['meme_id', 'text_content_type', 'platform', 'virality_score']]
        st.dataframe(
            top_posts,
        ...
        platform_avg = df.groupby('platform')[['likes', 'shares', 'comments', 'virality_score']].mean()
        st.dataframe(
            platform_avg,
            use_container_width=True
        )
